  ...
  <>
    ...
    {name === "addTopic" && (
      ...
      >
        ...
        <path d="M360,328v48H312a8,8,0,0,0,0,16h48v48a8,8,0,0,0,16,0V392h48a8,8,0,0,0,0-16H376V328a8,8,0,0,0-16,0Z" />
      </svg>
    )}
    {name === "topics" && (
      <svg
      ...
      >
        <g>
          <g>
            <path
              d="M360,408h-80v-16h64c4.417,0.001,7.999-3.579,8-7.996c0-0.001,0-0.003,0-0.004V128c0.001-4.417-3.579-7.999-7.996-8
        ...
        <g>
          <g>
            <path
              d="M136.004,0c-0.001,0-0.003,0-0.004,0H8C3.583-0.001,0.001,3.579,0,7.996C0,7.997,0,7.999,0,8v72
        ...
        <g>
          <g>
            <path
              d="M472.004,0c-0.001,0-0.003,0-0.004,0H344c-4.417-0.001-7.999,3.579-8,7.996c0,0.001,0,0.003,0,0.004v72
    ...
    {name === "posts" && (
      <svg viewBox="0 0 64 64" width="50" height="50" fill="#fff">
        <g id="Outline">
          <path d="M5.29,5.29a1.032,1.032,0,0,0-.21.33.942.942,0,0,0,0,.76.933.933,0,0,0,.21.33,1.014,1.014,0,0,0,1.42,0,1.014,1.014,0,0,0,0-1.42A1.047,1.047,0,0,0,5.29,5.29Z" />
          <path d="M8.62,5.08a.933.933,0,0,0-.33.21,1.014,1.014,0,0,0,0,1.42A1,1,0,0,0,10,6a1.052,1.052,0,0,0-.29-.71A1.017,1.017,0,0,0,8.62,5.08Z" />
          <path d="M11.62,5.08a1.032,1.032,0,0,0-.33.21,1.014,1.014,0,0,0,0,1.42,1.155,1.155,0,0,0,.33.21A1,1,0,0,0,12,7a.99.99,0,0,0,1-1,1.052,1.052,0,0,0-.29-.71A1.037,1.037,0,0,0,11.62,5.08Z" />
          <rect x="15" y="19" width="14" height="2" />
          <rect x="15" y="25" width="14" height="2" />
          <rect x="15" y="31" width="19" height="2" />
          <rect x="15" y="37" width="13" height="2" />
          <rect x="15" y="43" width="8" height="2" />
